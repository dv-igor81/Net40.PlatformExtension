...
internal class LogValuesFormatter
{
	...
	{
		return string.Format(CultureInfo.InvariantCulture, _format, new object[1] { FormatArgument(arg0) });
	}

	internal string Format(object arg0, object arg1)
	{
		return string.Format(CultureInfo.InvariantCulture, _format, new object[2]
		{
			FormatArgument(arg0),
			FormatArgument(arg1)
		});
	...
	{
		return string.Format(CultureInfo.InvariantCulture, _format, new object[3]
		{
			FormatArgument(arg0),
			FormatArgument(arg1),
			FormatArgument(arg2)
